                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="email" name="email"
                                        value="Ajeng Arumingsukma Agusiana" readonly>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="email" name="email" value="2131730115"
                                        readonly>
                                </div>

                                <label for="email" class="col-sm-5 col-form-label">Tanggal Lahir</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="email" name="email"
                                        value="01 Februari 2003" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
